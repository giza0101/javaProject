...
public class SocialMediaUser {
    ...
    1.A method "login" that accept a username and password as parameters and returns true
    if the username and password match the user's attributes, or false otherwise.
    2.A method named "resetPassword" that accepts a new password as a parameter and updates
    the user's password attribute to the new value.
    3.A method named "getFullName" that returns the user's full name(firstName + " +lastname).
    4,A method named "IsAdult" that returns true if the user's age is 18 or older,or false
    otherwise.
